...
class Htblhistory(models.Model):
    ...
    userid = models.ForeignKey('Htblusers', models.DO_NOTHING, db_column='userid', blank=True, null=True, related_name="twentyone")
    ticketid = models.ForeignKey('Htblticket', models.DO_NOTHING, db_column='ticketid', blank=True, null=True, related_name="twentytwo")
    date = models.DateTimeField(blank=True, null=True)
    typeid = models.ForeignKey('Htblhistorytypes', models.DO_NOTHING, db_column='typeid', related_name="twentythree")
    ...
    userid2 = models.ForeignKey('Htblusers', models.DO_NOTHING, db_column='userid2', blank=True, null=True, related_name="twentyfour")
    userid3 = models.ForeignKey('Htblusers', models.DO_NOTHING, db_column='userid3', blank=True, null=True, related_name="twentyfive")
    agentid2 = models.ForeignKey(Htblagents, models.DO_NOTHING, db_column='agentid2', blank=True, null=True, related_name="twentysix")
...
class Htblsourcelang(models.Model):
    ...
    language = models.ForeignKey('self', models.DO_NOTHING, db_column='language', related_name="thirtyfive")
    name = models.CharField(max_length=100, blank=True, null=True)
...
class Tbladcomputers(models.Model):
    ...
    assetid = models.ForeignKey('Tblassets', models.DO_NOTHING, db_column='AssetID', related_name="thirty")  # Field name made lowercase.
    ...
    lastchanged = models.DateTimeField(db_column='Lastchanged')  # Field name made lowercase.
    adobjectid = models.ForeignKey('Tbladobjects', models.DO_NOTHING, db_column='ADObjectID', blank=True, null=True, related_name="thirtyone")  # Field name made lowercase.
    manageradobjectid = models.ForeignKey('Tbladobjects', models.DO_NOTHING, db_column='ManagerADObjectId', blank=True, null=True, related_name="thirtytwo")  # Field name made lowercase.
...
class Tbladgroups(models.Model):
    ...
    adobjectid = models.ForeignKey('Tbladobjects', models.DO_NOTHING, db_column='ADObjectID', related_name="nineteen")  # Field name made lowercase.
    manageradobjectid = models.ForeignKey('Tbladobjects', models.DO_NOTHING, db_column='ManagerADObjectId', blank=True, null=True, related_name="twenty")  # Field name made lowercase.
...
class Tbladmembership(models.Model):
    childadobjectid = models.ForeignKey('Tbladobjects', models.DO_NOTHING, db_column='ChildAdObjectID', related_name="seventeen")  # Field name made lowercase.
    parentadobjectid = models.ForeignKey('Tbladobjects', models.DO_NOTHING, db_column='ParentAdObjectID', related_name="eighteen")  # Field name made lowercase.
    lastchanged = models.DateTimeField(db_column='lastChanged')  # Field name made lowercase.
...
class Tbladusers(models.Model):
    ...
    adobjectid = models.ForeignKey(Tbladobjects, models.DO_NOTHING, db_column='ADObjectID', blank=True, null=True, related_name="fifteen")  # Field name made lowercase.
    manageradobjectid = models.ForeignKey(Tbladobjects, models.DO_NOTHING, db_column='ManagerADObjectId', blank=True, null=True, related_name="sixteen")  # Field name made lowercase.
...
class Tblazureadgroupmembership(models.Model):
    ...
    azureadparentobjectid = models.ForeignKey('Tblazureadobject', models.DO_NOTHING, db_column='AzureAdParentObjectId', related_name="tweleve")  # Field name made lowercase.
    azureadchildobjectid = models.ForeignKey('Tblazureadobject', models.DO_NOTHING, db_column='AzureAdChildObjectId', related_name="thirteen")  # Field name made lowercase.
    azureadcontainerid = models.ForeignKey(Tblazureadcontainer, models.DO_NOTHING, db_column='AzureAdContainerId', related_name="fourteen")  # Field name made lowercase.
...
class Tblhypervlog(models.Model):
    ...
    hypervhostscannedid = models.ForeignKey(Tblassets, models.DO_NOTHING, db_column='HyperVHostScannedId', blank=True, null=True, related_name="seven")  # Field name made lowercase.
    hypervhostsourceid = models.ForeignKey(Tblassets, models.DO_NOTHING, db_column='HyperVHostSourceId', blank=True, null=True, related_name="eight")  # Field name made lowercase.
    hypervhostdestinationid = models.ForeignKey(Tblassets, models.DO_NOTHING, db_column='HyperVHostDestinationId', blank=True, null=True, related_name="nine")  # Field name made lowercase.
    hypervguestid = models.ForeignKey(Tblhypervguest, models.DO_NOTHING, db_column='HyperVGuestId', blank=True, null=True, related_name="ten")  # Field name made lowercase.
    ...
    eventmessageid = models.ForeignKey('Tblntlogmessage', models.DO_NOTHING, db_column='EventMessageId', related_name="eleven")  # Field name made lowercase.
    lastchanged = models.DateTimeField(db_column='LastChanged')  # Field name made lowercase.
...
class Tblwindowsclusterlog(models.Model):
    ...
    windowsclusterid = models.ForeignKey(Tblwindowscluster, models.DO_NOTHING, db_column='WindowsClusterId', related_name="one")  # Field name made lowercase.
    windowsclusternodescannedid = models.ForeignKey('Tblwindowsclusternode', models.DO_NOTHING, db_column='WindowsClusterNodeScannedId', blank=True, null=True, related_name="two")  # Field name made lowercase.
    windowsclusternodesourceid = models.ForeignKey('Tblwindowsclusternode', models.DO_NOTHING, db_column='WindowsClusterNodeSourceId', blank=True, null=True, related_name="three")  # Field name made lowercase.
    windowsclusternodedestinationid = models.ForeignKey('Tblwindowsclusternode', models.DO_NOTHING, db_column='WindowsClusterNodeDestinationId', blank=True, null=True, related_name="four")  # Field name made lowercase.
    hypervguestid = models.ForeignKey(Tblhypervguest, models.DO_NOTHING, db_column='HyperVGuestId', blank=True, null=True, related_name="five")  # Field name made lowercase.
    action = models.IntegerField(db_column='Action', blank=True, null=True)  # Field name made lowercase.
    eventtimecreated = models.DateTimeField(db_column='EventTimeCreated')  # Field name made lowercase.
    eventid = models.IntegerField(db_column='EventId')  # Field name made lowercase.
    eventlevelid = models.IntegerField(db_column='EventLevelId')  # Field name made lowercase.
    eventmessageid = models.ForeignKey(Tblntlogmessage, models.DO_NOTHING, db_column='EventMessageId', related_name="six")  # Field name made lowercase.
    lastchanged = models.DateTimeField(db_column='LastChanged')  # Field name made lowercase.
